...
export function PerformanceReport({ scores, studentName, onContinueToReflection, onBack }: PerformanceReportProps) {
  const categories = [
    ...
    { step: 4, label: "Community Action Planning", score: scores.interventionPlanning, desc: "Feasibility, completeness, and initial budget/timeline realism" },
  ...
  return (
    <Card className="max-w-2xl mx-auto border shadow-lg overflow-hidden animate-fade-in-up">
      ...
      <CardContent className="p-6 space-y-6">
        ...
        {/* 6-Core Competency Performance Timeline Audit */}
        <div className="space-y-3">
          <h4 className="text-xs font-bold uppercase tracking-wider text-muted-foreground">
            6-Core Competency Evaluation Timeline
          </h4>
